...
def main():
    ...
    for num in vet_length:
        arr = inversely_ordered_vector(num)  # Gerar vetor inversamente ordenado
    ...
    plot_graph(vet_length, algorithm_times, "Comparação de Algoritmos de Ordenação - Vetor Inversamente Ordenado")
